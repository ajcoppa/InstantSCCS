...
const craftedCBBFoods: Item[] = $items`honey bun of Boris, roasted vegetable of Jarlsberg, Pete's rich ricotta, plain calzone, Boris's bread`;
  ...
  tasks: [
    ...
    },
    {
      ...
      completed: () =>
        ...
        get("instant_saveEuclideanAngle", false) || // TODO: Adjust pref name
